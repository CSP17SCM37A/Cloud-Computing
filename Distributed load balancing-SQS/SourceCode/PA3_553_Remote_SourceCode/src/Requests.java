...
public class Requests {
    ...
    private void init() throws Exception {
        /*
         * The ProfileCredentialsProvider will return your [default1]
         * credential profile by reading from the credentials file located at
         * (/home/chiru/.aws/credentials).
         */
    ...
    public void submitRequests() {
        ...
        requestRequest.setSpotPrice("0.65");
        requestRequest.setInstanceCount(Integer.valueOf(2));

        // Setup the specifications of the launch. This includes the instance type (e.g. t1.micro)
        // and the latest Amazon Linux AMI id available. Note, you should always use the latest
        // Amazon Linux AMI id or another of your choosing.
        LaunchSpecification launchSpecification = new LaunchSpecification();
        launchSpecification.setImageId("ami-c229c0a2");
        launchSpecification.setInstanceType("c3.large");

        // Add the security group to the request.
        ArrayList<String> securityGroups = new ArrayList<String>();
        securityGroups.add("jayanth");
        launchSpecification.withKeyName("chiruoregon");
